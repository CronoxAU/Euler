...
class Test_TestProblem31(unittest.TestCase):
    ...
    def test_getTotalFromCoins2P(self):
        self.assertEqual(problem31.getTotalFromCoins(2,0,0,0,0,0,0,0), 200)
    ...
    def test_numberOfWaysToMakeNPounds6p(self):
        self.assertEqual(problem31.numberOfWaysToMakeNPounds(.06), 6)

    #test of full solution
    #def test_sumOfAllMthPower(self):
    #    self.assertEqual(problem31.numberOfWaysToMakeNPounds(2), 0)
